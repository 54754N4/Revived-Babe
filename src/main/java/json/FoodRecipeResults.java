...
public final class FoodRecipeResults {
	public final String title, href;
	public final float version;
	public final Result[] results;
	
	public FoodRecipeResults(String title, float version, String href, Result[] results) {
		this.title = title;
	...
	public static final class Result {
		public final String title, href, ingredients, thumbnail;
